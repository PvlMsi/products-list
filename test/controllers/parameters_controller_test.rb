...
class ParametersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post parameters_url, params: { parameter: { data_type: @parameter.data_type, name: @parameter.name, options: @parameter.options } }
    end
  ...
  test "should update parameter" do
    patch parameter_url(@parameter), params: { parameter: { data_type: @parameter.data_type, name: @parameter.name, options: @parameter.options } }
